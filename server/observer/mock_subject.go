...
// Source: github.com/rmarken5/cfcs/server/observer (interfaces: Subject)
...
import (
	...
	common "github.com/rmarken5/cfcs/common"
)
...
func (m *MockSubject) AddFile(arg0 common.FileInfo) {
	m.ctrl.T.Helper()
...
func (m *MockSubject) GetFiles() []common.FileInfo {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFiles")
	ret0, _ := ret[0].([]common.FileInfo)
	return ret0
}
...
func (m *MockSubject) NotifyAllWithFiles(arg0 []common.FileInfo) {
	m.ctrl.T.Helper()
...
func (m *MockSubject) RemoveFile(arg0 common.FileInfo) {
	m.ctrl.T.Helper()
...
func (m *MockSubject) SetFiles(arg0 []common.FileInfo) {
	m.ctrl.T.Helper()
