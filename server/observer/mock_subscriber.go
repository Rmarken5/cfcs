...
// Source: github.com/rmarken5/cfcs/server/observer (interfaces: Subscriber)
...
func (m *MockSubscriber) NotifyAllWithFile(arg0 common.FileInfo) {
	m.ctrl.T.Helper()
...
func (m *MockSubscriber) NotifyAllWithFiles(arg0 []common.FileInfo) {
	m.ctrl.T.Helper()
