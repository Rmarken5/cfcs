...
//go:generate mockgen -destination=./mock_observer.go -package=observer . Observer
//go:generate mockgen -destination=./mock_subscriber.go -package=observer . Subscriber
//go:generate mockgen -destination=./mock_subject.go -package=observer . Subject
